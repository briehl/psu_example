...
from psu_example.psu_exampleImpl import psu_example
from psu_example.psu_exampleServer import MethodContext
from psu_example.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class psu_exampleTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('psu_example'):
        ...
        cls.serviceImpl = psu_example(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_psu_example_" + str(suffix)
